            ...
            render={({ field }) => (
              <FormItem>
                <FormControl>
                  <Input
                    placeholder="Email"
                    className="text-white! aria-invalid:ring-0! w-96  font-normal! aria-invalid:border-b-destructive! border-transparent pb-8! h-auto! text-[1.375rem]!  rounded-none! border-b-mint"
                    {...field}
                  />
                </FormControl>
