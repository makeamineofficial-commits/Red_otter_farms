...
import { NutritionMeterDrawer } from "./nutritionMeter";
  ...
  return (
    <>
      <NutritionMeterDrawer
        ...
        setIsOpen={setOpen}
      ></NutritionMeterDrawer>
      <div className=" flex md:hidden fixed bottom-0 left-1/2 -translate-x-1/2 z-50  items-center justify-center gap-2">
        <div
          className="mb-5 flex items-center justify-center h-14 w-14 rounded-full bg-forest text-white"
          onClick={() => setOpen((prev) => !prev)}
        >
          <Flame className="size-8"></Flame>
        </div>
