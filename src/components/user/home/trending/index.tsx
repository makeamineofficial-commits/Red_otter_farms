      ...
      <div className="flex items-stretch gap-12">
        ...
        <article className="flex-1 min-w-0">
          <div className="flex gap-4 md:gap-8 flex-col">
            ...
            <h1 className="font-dream-orphans uppercase flex flex-col leading-22 text-[2rem] lg:text-[3.5rem] 2xl:text-[4.75rem] tracking-[6px]">
              Salad greens that stay crisp
            </h1>

            <p className="max-w-176 opacity-80 my-10 text-justify  text-[1rem] lg:text-[1.375rem]">
