    ...
    <section className="bg-mint grid grid-cols-2 gap-18 p-18">
      ...
      <article className="py-16 space-y-6">
        ...
        >
          ...
          <AccordionItem value="item-4" className="border-b border-b-forest">
            <AccordionTrigger className="text-[1.725rem] font-light tracking-[1.42px] w-full">
          ...
          <AccordionItem value="item-5" className="border-b border-b-forest">
            <AccordionTrigger className="text-[1.725rem] font-light tracking-[1.42px] w-full">
          ...
          <AccordionItem value="item-6" className="border-b border-b-forest">
            <AccordionTrigger className="text-[1.725rem] font-light tracking-[1.42px] w-full">
